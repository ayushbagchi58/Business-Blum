      ...
      <div className="space-y-5">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                h-12 w-full rounded-xl border bg-white pl-8 pr-4
                text-sm text-[#08122E] outline-none
                transition-all duration-300
                focus:border-[#0EA56B] focus:ring-4 focus:ring-[#0EA56B]/10
                40{errors.fundingAmount ? "border-red-400" : "border-gray-300"}
              `}
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                ...
                transition-all duration-300
                focus:border-[#0EA56B] focus:ring-4 focus:ring-[#0EA56B]/10
                40{errors.monthlyRevenue ? "border-red-400" : "border-gray-300"}
              `}
            />
          </div>
        ...
        <div>
          ...
          <select
            ...
            className={`
              ...
              transition-all duration-300
              focus:border-[#0EA56B] focus:ring-4 focus:ring-[#0EA56B]/10
              40{errors.industry ? "border-red-400" : "border-gray-300"}
            `}
          >
        ...
        <div>
          ...
          <select
            ...
            className={`
              ...
              transition-all duration-300
              focus:border-[#0EA56B] focus:ring-4 focus:ring-[#0EA56B]/10
              40{errors.timeInBusiness ? "border-red-400" : "border-gray-300"}
            `}
          >
        ...
        <div className="mt-6 rounded-xl bg-gradient-to-br from-[#0EA56B]/10 to-[#0EA56B]/5 p-4">
          <p className="text-xs text-gray-700">
            ...
            - This won&apos;t affect your credit score. We match you with the
