  ...
  return (
    <section className="w-full bg-white py-6 sm:py-8 md:py-10">
      <div className="mx-auto w-full max-w-[1567px] px-4 sm:px-6 lg:px-8">
        <div className="rounded-[22px] border border-black/5 bg-white px-4 py-6 shadow-[0_8px_30px_rgba(0,0,0,0.06)] -translate-y-25 sm:px-6 md:px-8 md:py-7">
          <div className="grid grid-cols-2 gap-x-4 gap-y-8 md:grid-cols-4 md:gap-x-6 md:gap-y-0">
            {stats.map((item, index) => (
              ...
              >
                <h2 className="whitespace-nowrap text-[28px] font-black tracking-tight text-[#00A36C] sm:text-[34px] md:text-[38px] lg:text-[44px]">
                  <CountUp
                    value={item.value}
                    prefix={item.prefix}
                    suffix={item.suffix}
