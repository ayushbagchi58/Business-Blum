  ...
  return (
    <section className="relative flex min-h-[78vh] w-full items-center justify-center overflow-hidden bg-[#020817] px-5 py-10 sm:px-8 lg:px-12">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center text-center">
        ...
        >
          Complete your application in minutes and discover lenders that fit
          your needs.
        </motion.p>
        ...
        >
          <motion.button
            ...
            className="group flex items-center gap-2 rounded-xl bg-emerald-500 px-6 py-3.5 text-sm font-semibold text-white shadow-[0_10px_25px_rgba(16,185,129,0.25)] transition-all duration-300 hover:bg-emerald-400"
          >
            Start Application
