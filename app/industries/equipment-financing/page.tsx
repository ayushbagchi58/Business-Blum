...
export const metadata: Metadata = {
  ...
  description: "Finance any business equipment from $5K to $5M. Manufacturing, medical, construction, restaurant equipment and more. Fast approvals and competitive rates.",
  keywords: "equipment financing, equipment leasing, machinery loans, business equipment funding, equipment purchase",
};
