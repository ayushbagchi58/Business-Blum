...
export const metadata: Metadata = {
  ...
  description: "Quick restaurant financing from $5K to $5M. Fund renovations, equipment, inventory, and payroll. Fast approval for cafes, bars, and food service businesses.",
  keywords: "restaurant loans, cafe financing, bar funding, food service loans, restaurant working capital",
};
