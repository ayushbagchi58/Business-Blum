...
export const metadata: Metadata = {
  ...
  description: "Auto repair shop financing from $5K to $2M. Fund equipment, tools, inventory, and expansion. Fast approval for mechanics and automotive service businesses.",
  keywords: "auto shop loans, auto repair financing, mechanic shop funding, automotive business loans, body shop financing",
};
