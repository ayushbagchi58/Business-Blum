...
export const metadata: Metadata = {
  ...
  description: "Healthcare financing from $10K to $5M for doctors, dentists, and medical practices. Fund equipment, expansion, working capital, and practice acquisitions.",
  keywords: "medical practice loans, healthcare financing, doctor loans, dental practice funding, medical equipment financing",
};
