...
export const metadata: Metadata = {
  ...
  description:
    "Fast trucking business loans from $5K to $10M. Finance trucks, trailers, and working capital for owner-operators and fleet owners. Approvals in 24 hours.",
  keywords:
    "trucking loans, semi truck financing, fleet funding, owner operator loans, commercial truck financing",
};
